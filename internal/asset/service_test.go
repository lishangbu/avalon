...
func TestServiceRejectsSpoofedImageBytes(t *testing.T) {
	...
	repository := &adaptersStub{value: pending}
...
func TestServiceReplaysCompletedConfirmationWithoutReadingBlobAgain(t *testing.T) {
	...
	repository := &adaptersStub{value: asset.Asset{
...
func TestServiceListsOwnedAssets(t *testing.T) {
	...
	repository := &adaptersStub{page: asset.Page{
...
func (s *adaptersStub) ListOwned(_ context.Context, ownerID snowflake.ID, query asset.ListQuery) (asset.Page, error) {
	s.listCalls++
...
func (s *adaptersStub) GetOwned(_ context.Context, _, _ snowflake.ID) (asset.Asset, error) {
...
func (s *adaptersStub) WithinAsset(ctx context.Context, work func(asset.Writer) error) error {
