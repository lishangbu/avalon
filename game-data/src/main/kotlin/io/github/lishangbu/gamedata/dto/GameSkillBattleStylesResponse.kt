 ...
 * 技能战斗风格响应。
 */
@Schema(name = "GameSkillBattleStylesResponse", description = "技能战斗风格响应。")
data class GameSkillBattleStylesResponse(
	...
	companion object {
		fun from(record: GameDataRecordResponse): GameSkillBattleStylesResponse =
