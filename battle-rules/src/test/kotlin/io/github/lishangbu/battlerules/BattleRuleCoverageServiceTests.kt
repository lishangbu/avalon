...
class BattleRuleCoverageServiceTests {
	...
	fun `coverage summary matches item statuses`() {
		...
		assertEquals(200, coverage.targetSummary.coveredRuleCount)
		assertEquals(112, coverage.targetSummary.remainingRuleCount)
		assertEquals(64, coverage.targetSummary.implementationPercent)
