...
class BattleSkillRuntimeLookup(
	...
	fun skillSlotBySkillId(skillId: Long): BattleSkillSlot {
		...
		return BattleSkillSlot(
			...
			bypassesSubstitute = effectPolicy.bypassesSubstitute(),
			...
			projectileBased = row.requiredBoolean(row.projectileBased, "projectile_based"),
			pulseBased = row.requiredBoolean(row.pulseBased, "pulse_based"),
			biteBased = row.requiredBoolean(row.biteBased, "bite_based"),
			...
			requiresTargetPendingDamagingSkill = effectPolicy.requiresTargetPendingDamagingSkill(),
			requiresTargetPendingPriorityDamagingSkill = effectPolicy.requiresTargetPendingPriorityDamagingSkill(),
			protectsUserSideFromMultiTargetSkills = effectPolicy.protectsUserSideFromMultiTargetSkills(),
			protectsUserSideFromPrioritySkills = effectPolicy.protectsUserSideFromPrioritySkills(),
			...
			curesUserMajorStatus = effectPolicy.curesUserMajorStatus(),
...
private fun toSkillRuntimeRow(
	...
	SkillRuntimeRow(
		...
		projectileBased = rule?.projectileBased,
		pulseBased = rule?.pulseBased,
		biteBased = rule?.biteBased,
