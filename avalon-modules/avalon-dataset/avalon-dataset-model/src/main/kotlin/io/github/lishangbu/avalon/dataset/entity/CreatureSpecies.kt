...
interface CreatureSpecies {
    ...
    /** 生物颜色 */
    @ManyToOne
    @JoinColumn(name = "creature_color_id")
    val creatureColor: CreatureColor?

    /** 生物形态 */
    @ManyToOne
    @JoinColumn(name = "creature_shape_id")
    val creatureShape: CreatureShape?
    ...
    /** 生物栖息地 */
    @ManyToOne
    @JoinColumn(name = "creature_habitat_id")
    val creatureHabitat: CreatureHabitat?
}
