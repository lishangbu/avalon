...
include(":avalon-modules:avalon-game:avalon-game-controller")
include(":avalon-modules:avalon-game:avalon-game-player")
include(":avalon-modules:avalon-game:avalon-game-service")
