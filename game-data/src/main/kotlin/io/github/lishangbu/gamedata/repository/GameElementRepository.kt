...
class GameElementRepository(
	...
	fun list(
		...
		operations.list(GAME_ELEMENT_TABLE, page, size, query, filters)

	fun get(id: Long): GameDataRecordResponse =
		operations.get(GAME_ELEMENT_TABLE, id)

	fun create(request: GameDataRecordRequest): GameDataRecordResponse =
		operations.create(GAME_ELEMENT_TABLE, request)

	fun update(id: Long, request: GameDataRecordRequest): GameDataRecordResponse =
		operations.update(GAME_ELEMENT_TABLE, id, request)

	fun delete(id: Long) {
		operations.delete(GAME_ELEMENT_TABLE, id)
	}
}
