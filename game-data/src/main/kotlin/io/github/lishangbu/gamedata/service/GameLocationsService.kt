...
class GameLocationsService(
	...
	): Page<GameLocationsResponse> {
		validatePage(page, size)
		val search = searchFilter(query)
		return sqlClient.createQuery(GameLocations::class) {
	...
	private fun entityByIdOrNotFound(id: Long): GameLocations =
		repository.findNullable(id) ?: notFound("id", "地点资料不存在: $id")

	private fun GameLocations.toResponse(): GameLocationsResponse =
