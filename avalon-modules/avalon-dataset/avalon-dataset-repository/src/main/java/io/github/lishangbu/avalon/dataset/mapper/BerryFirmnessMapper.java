 ...
 *
 * <p>提供树果硬度数据的 CRUD 操作 继承 MyBatis-Plus BaseMapper，自动获得基础的增删改查方法 包含自定义的查询方法用于业务需求
 *
 * @author lishangbu
 * @since 2025/09/14
 */
@Mapper
public interface BerryFirmnessMapper extends BaseMapper<BerryFirmness> {
   ...
   * 查询树果硬度列表（支持动态条件）
   *
   * <p>根据提供的查询条件动态筛选树果硬度数据 支持按 ID、内部名称、显示名称等条件进行查询 按 ID 升序排列返回
   *
   * @param berryFirmness 查询条件对象，包含筛选条件
