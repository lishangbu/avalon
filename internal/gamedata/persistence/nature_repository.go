...
// GetNature 查询指定 Nature。
func (s *Adapters) GetNature(ctx context.Context, id snowflake.ID) (nature.Nature, error) {
...
// ListNatures 返回 Nature 资料页。
func (s *Adapters) ListNatures(ctx context.Context, query nature.ListQuery) (nature.Page, error) {
