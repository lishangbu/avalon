 ...
 * 技能异常响应。
 */
@Schema(name = "GameSkillAilmentsResponse", description = "技能异常响应。")
data class GameSkillAilmentsResponse(
	...
	companion object {
		fun from(record: GameDataRecordResponse): GameSkillAilmentsResponse =
