...
class GameEggGroupService(
	...
	): Page<GameEggGroupResponse> {
		validatePage(page, size)
		val search = searchFilter(query)
		return sqlClient.createQuery(GameEggGroup::class) {
	...
	private fun entityByIdOrNotFound(id: Long): GameEggGroup =
		repository.findNullable(id) ?: notFound("id", "种类分组不存在: $id")

	private fun GameEggGroup.toResponse(): GameEggGroupResponse =
