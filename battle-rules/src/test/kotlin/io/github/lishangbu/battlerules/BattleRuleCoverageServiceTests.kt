...
class BattleRuleCoverageServiceTests {
	...
	fun `coverage summary matches item statuses`() {
		...
		assertEquals(182, coverage.targetSummary.coveredRuleCount)
		assertEquals(130, coverage.targetSummary.remainingRuleCount)
		assertEquals(58, coverage.targetSummary.implementationPercent)
