 ...
 * 道具属性响应。
 */
@Schema(name = "GameItemAttributesResponse", description = "道具属性响应。")
data class GameItemAttributesResponse(
	...
	companion object {
		fun from(record: GameDataRecordResponse): GameItemAttributesResponse =
