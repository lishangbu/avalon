...
/// API 响应结果包装增强器，统一封装所有 Controller 返回值为 ApiResult
///
/// 支持自动包装普通对象、字符串类型和已包装的 ApiResult 类型，字符串类型特殊处理，保证响应内容为标准 JSON
/// 适用于 io.github.lishangbu.avalon 包下所有 RestController
///
/// @author lishangbu
/// @since 2023/5/1
