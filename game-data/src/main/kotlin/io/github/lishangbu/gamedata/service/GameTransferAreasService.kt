...
class GameTransferAreasService(
	...
	): Page<GameTransferAreasResponse> {
		validatePage(page, size)
		val search = searchFilter(query)
		return sqlClient.createQuery(GameTransferAreas::class) {
	...
	private fun entityByIdOrNotFound(id: Long): GameTransferAreas =
		repository.findNullable(id) ?: notFound("id", "迁移区域不存在: $id")

	private fun GameTransferAreas.toResponse(): GameTransferAreasResponse =
