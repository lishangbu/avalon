...
func (w *battleRuleTransactionRepository) CreateRestriction(ctx context.Context, record battleformat.CreateRestrictionRecord) (battleformat.Restriction, error) {
...
func (w *battleRuleTransactionRepository) UpdateRestriction(ctx context.Context, record battleformat.UpdateRestrictionRecord) (battleformat.Restriction, error) {
...
func (w *battleRuleTransactionRepository) DisableRestriction(ctx context.Context, record battleformat.DisableRestrictionRecord) error {
...
func (s *Adapters) GetRestriction(ctx context.Context, id snowflake.ID) (battleformat.Restriction, error) {
...
func (s *Adapters) ListRestrictions(ctx context.Context, query battleformat.RestrictionListQuery) (battleformat.RestrictionPage, error) {
