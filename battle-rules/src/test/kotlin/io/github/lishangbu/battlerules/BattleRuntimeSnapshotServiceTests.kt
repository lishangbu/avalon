	...
	fun `skill slot assembly includes explicit battle rule effects`() {
		val slots = service.skillSlotsBySkillIds(
			listOf(
				...
				464, 473, 474, 475, 480, 484, 486, 500, 504, 505, 506, 512, 515, 526, 535, 540, 548, 564, 568, 570, 577, 580, 604, 610, 611, 659, 664, 666, 668, 681, 682, 685, 694, 711, 717, 794, 795, 803, 804, 805, 819, 875, 877,
				883, 892, 895,
			),
		)
