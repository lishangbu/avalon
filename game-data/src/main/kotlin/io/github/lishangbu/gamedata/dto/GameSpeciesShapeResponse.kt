 ...
 * 种类形态响应。
 */
@Schema(name = "GameSpeciesShapeResponse", description = "种类形态响应。")
data class GameSpeciesShapeResponse(
	...
	companion object {
		fun from(record: GameDataRecordResponse): GameSpeciesShapeResponse =
