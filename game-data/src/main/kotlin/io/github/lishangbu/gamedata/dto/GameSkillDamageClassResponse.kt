 ...
 * 技能分类响应。
 */
@Schema(name = "GameSkillDamageClassResponse", description = "技能分类响应。")
data class GameSkillDamageClassResponse(
	...
	companion object {
		fun from(record: GameDataRecordResponse): GameSkillDamageClassResponse =
