 ...
 * 技能目标响应。
 */
@Schema(name = "GameSkillTargetsResponse", description = "技能目标响应。")
data class GameSkillTargetsResponse(
	...
	companion object {
		fun from(record: GameDataRecordResponse): GameSkillTargetsResponse =
