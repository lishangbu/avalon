...
import io.github.lishangbu.gamedata.service.GameCreatureSkillLearnsService
...
class GameCreatureSkillLearnsController(
	...
	): Page<GameCreatureSkillLearnsResponse> = service.list(page, size, q, request.toGameDataFilters())
