...
class ItemAttributeServiceImpl(
    ...
    @Transactional(rollbackFor = [Exception::class])
    override fun update(command: UpdateItemAttributeInput): ItemAttributeView = ItemAttributeView(itemAttributeRepository.save(command.toEntity(), SaveMode.UPDATE_ONLY))
