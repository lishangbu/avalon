...
func (s *Adapters) GetManagedItemRules(ctx context.Context, itemID snowflake.ID) (item.Rules, error) {
...
func (s *Adapters) ReplaceItemRules(ctx context.Context, record item.ReplaceRulesRecord) (item.Rules, error) {
...
func (s *Adapters) createItemRuleRelations(ctx context.Context, client *avalonent.Client, record item.ReplaceRulesRecord) error {
	r := record.Rules
...
func (s *Adapters) createRemainingItemRules(ctx context.Context, client *avalonent.Client, record item.ReplaceRulesRecord, createID func() (snowflake.ID, error)) error {
	r := record.Rules
