 ...
 * 树果硬度响应。
 */
@Schema(name = "GameBerryFirmnessesResponse", description = "树果硬度响应。")
data class GameBerryFirmnessesResponse(
	...
	companion object {
		fun from(record: GameDataRecordResponse): GameBerryFirmnessesResponse =
