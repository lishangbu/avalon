...
class GameHabitatService(
	...
	): Page<GameHabitatResponse> {
		validatePage(page, size)
		val search = searchFilter(query)
		return sqlClient.createQuery(GameHabitat::class) {
	...
	private fun entityByIdOrNotFound(id: Long): GameHabitat =
		repository.findNullable(id) ?: notFound("id", "栖息地不存在: $id")

	private fun GameHabitat.toResponse(): GameHabitatResponse =
		GameHabitatResponse {
