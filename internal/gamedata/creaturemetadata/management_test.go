...
func TestAdministrationCleansAndBoundsSpeciesReferenceCopy(t *testing.T) {
	repository := &managementAdaptersStub{}
...
func TestAdministrationListsSpeciesWithBoundedPagination(t *testing.T) {
	repository := &managementAdaptersStub{speciesPage: creaturemetadata.SpeciesPage{Page: 2, PageSize: 25, Total: 26}}
	service := creaturemetadata.NewAdministrationService(repository, repository, repository, snowflake.TestSource(func() snowflake.ID { return snowflake.NewTestID() }), time.Now)
...
type managementAdaptersStub struct {
...
func (s *managementAdaptersStub) GetReferenceOptions(context.Context) (creaturemetadata.ReferenceOptions, error) {
	return creaturemetadata.ReferenceOptions{}, nil
}

func (s *managementAdaptersStub) ListSpecies(_ context.Context, query creaturemetadata.SpeciesListQuery) (creaturemetadata.SpeciesPage, error) {
	s.speciesQuery = query
	return s.speciesPage, nil
}

func (s *managementAdaptersStub) GetSpecies(context.Context, snowflake.ID) (creaturemetadata.ManagedSpecies, error) {
	return creaturemetadata.ManagedSpecies{}, nil
}

func (s *managementAdaptersStub) ListCreatures(context.Context, creaturemetadata.CreatureListQuery) (creaturemetadata.CreaturePage, error) {
	return creaturemetadata.CreaturePage{}, nil
}

func (s *managementAdaptersStub) GetCreature(context.Context, snowflake.ID) (creaturemetadata.ManagedCreature, error) {
	return creaturemetadata.ManagedCreature{}, nil
}
func (s *managementAdaptersStub) GetCreatureRelations(context.Context, snowflake.ID) (creaturemetadata.CreatureRelations, error) {
	return s.relations, nil
}

func (s *managementAdaptersStub) WithinCreatureData(_ context.Context, work func(creaturemetadata.ManagementWriter) error) error {
	return work(s)
}

func (s *managementAdaptersStub) CreateSpecies(_ context.Context, record creaturemetadata.CreateSpeciesRecord) (creaturemetadata.ManagedSpecies, error) {
	return record.Species, nil
}

func (s *managementAdaptersStub) UpdateSpecies(_ context.Context, record creaturemetadata.UpdateSpeciesRecord) (creaturemetadata.ManagedSpecies, error) {
	return record.Species, nil
}

func (s *managementAdaptersStub) CreateCreature(_ context.Context, record creaturemetadata.CreateCreatureRecord) (creaturemetadata.ManagedCreature, error) {
	return record.Creature, nil
}

func (s *managementAdaptersStub) UpdateCreature(_ context.Context, record creaturemetadata.UpdateCreatureRecord) (creaturemetadata.ManagedCreature, error) {
	s.updatedCreature = record.Creature
	return record.Creature, nil
}
func (s *managementAdaptersStub) ReplaceCreatureRelations(_ context.Context, record creaturemetadata.ReplaceRelationsRecord) (creaturemetadata.CreatureRelations, error) {
