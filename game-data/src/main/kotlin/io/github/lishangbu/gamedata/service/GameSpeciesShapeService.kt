...
class GameSpeciesShapeService(
	...
	): Page<GameSpeciesShapeResponse> {
		validatePage(page, size)
		val search = searchFilter(query)
		return sqlClient.createQuery(GameSpeciesShape::class) {
	...
	private fun entityByIdOrNotFound(id: Long): GameSpeciesShape =
		repository.findNullable(id) ?: notFound("id", "种类形态不存在: $id")

	private fun GameSpeciesShape.toResponse(): GameSpeciesShapeResponse =
