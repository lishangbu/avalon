 ...
 * 进化触发器响应。
 */
@Schema(name = "GameEvolutionTriggersResponse", description = "进化触发器响应。")
data class GameEvolutionTriggersResponse(
	...
	companion object {
		fun from(record: GameDataRecordResponse): GameEvolutionTriggersResponse =
