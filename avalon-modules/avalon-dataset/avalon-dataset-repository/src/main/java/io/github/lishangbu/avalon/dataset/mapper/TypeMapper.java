...
/// 属性(Type)数据访问层
///
/// 提供属性数据的 CRUD 操作，继承 MyBatis-Plus BaseMapper，并包含自定义查询方法
///
/// @author lishangbu
/// @since 2025/09/14
@Mapper
public interface TypeMapper extends BaseMapper<Type> {
  ...
  /// 查询属性列表（支持动态条件）
  ///
  /// 根据提供的查询条件动态筛选属性数据，支持按 ID、内部名称、显示名称等条件进行查询，按 ID 升序排列返回
  ///
  ...
  /// 分页查询属性列表（支持动态条件）
  ///
  /// 根据提供的查询条件和分页参数进行分页查询，支持按 ID、内部名称、显示名称等条件进行筛选，按 ID 升序排列返回分页结果
  ///
