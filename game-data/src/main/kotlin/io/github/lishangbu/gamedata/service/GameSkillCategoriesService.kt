...
class GameSkillCategoriesService(
	...
	): Page<GameSkillCategoriesResponse> {
		validatePage(page, size)
		val search = searchFilter(query)
		return sqlClient.createQuery(GameSkillCategories::class) {
	...
	private fun entityByIdOrNotFound(id: Long): GameSkillCategories =
		repository.findNullable(id) ?: notFound("id", "技能元分类不存在: $id")

	private fun GameSkillCategories.toResponse(): GameSkillCategoriesResponse =
