...
| `hit-protect-substitute-immunity-reflect` | 81-108 | 28 | `BattleEndurePublicReferenceTests`、`BattleHitDefenseBoundaryPublicReferenceTests`、`BattleSubstituteTests`、`BattleImmunityTests`、`BattleAccuracyStatStageIgnoreAbilityTests`、`BattlePsychicTerrainTests`、`BattleSoundAbilityTests`、`BattleStatusImmunityAndGroundingTests` |
