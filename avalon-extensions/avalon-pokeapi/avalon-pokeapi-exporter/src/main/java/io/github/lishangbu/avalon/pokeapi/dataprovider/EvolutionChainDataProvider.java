...
public class EvolutionChainDataProvider implements PokeApiDataProvider<EvolutionChainExcelDTO> {
  ...
  private EvolutionChainExcelDTO resolveEvolutionChainExcelDTO(
      Integer fromPokemonSpeciesId, Integer toPokemonSpeciesId, EvolutionDetail evolutionDetail) {
    ...
    chainExcelDTO.setKnownMoveTypeId(NamedApiResourceUtils.getId(evolutionDetail.knownMoveType()));
    ...
    chainExcelDTO.setPartySpeciesId(NamedApiResourceUtils.getId(evolutionDetail.partySpecies()));
    ...
    chainExcelDTO.setTradeSpeciesId(NamedApiResourceUtils.getId(evolutionDetail.tradeSpecies()));
