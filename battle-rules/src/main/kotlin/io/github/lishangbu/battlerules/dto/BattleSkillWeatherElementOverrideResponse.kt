...
@Immutable
interface BattleSkillWeatherElementOverrideResponse {
	@get:Schema(type = "string", description = "技能天气属性覆盖主键 ID。", example = "1")
	@JsonConverter(LongToStringConverter::class)
	val id: Long
	@get:Schema(type = "string", description = "技能规则 ID。", example = "13")
	@JsonConverter(LongToStringConverter::class)
	val skillRuleId: Long
	@get:Schema(type = "string", description = "天气规则 ID。", example = "3")
	@JsonConverter(LongToStringConverter::class)
	val weatherRuleId: Long
	@get:Schema(type = "string", description = "目标属性 ID。", example = "11")
	@JsonConverter(LongToStringConverter::class)
