...
class BattleWeatherEffectTests {
	...
	fun `sandstorm damages only non immune active participants at end turn`() {
		...
		scenario.assertNamed("sandstorm-damages-only-non-immune-active-participants")
	...
	fun `weather healing ability heals active participant at end turn`() {
		...
		scenario.assertNamed("weather-healing-ability-heals-active-participant-at-end-turn")
	...
	fun `weather speed ability changes skill action order`() {
		...
		scenario.assertNamed("weather-speed-ability-changes-skill-action-order")
		assertEquals(
	...
	fun `weather accuracy overrides support sure hit and lowered accuracy`() {
		...
		scenario.assertNamed("weather-accuracy-overrides-support-sure-hit-and-lowered-accuracy")
	...
	fun `ability and item immunities block sandstorm damage`() {
		...
		scenario.assertNamed("ability-and-item-immunities-block-sandstorm-damage")
