...
/**
 * 单元测试：IpUtils 测试网络地址工具类的功能（IPv4/IPv6 判定与转换、CIDR 与十进制转换等）
 *
 * @author lishangbu
 * @since 2025/4/12
 */
class IpUtilsTest {
    ...
    @Test
    fun ipv4ToDecimal() {
        assertEquals(BigInteger.valueOf(134_744_072), IpUtils.ipv4ToDecimal("8.8.8.8"))
    ...
    fun ipv6ToDecimal() {
        assertEquals(
            BigInteger("50511294517568083089461819682126352108"),
    ...
    fun decimalToIpv4() {
        assertEquals("8.8.8.8", IpUtils.decimalToIpv4(BigInteger.valueOf(134_744_072)))
    }
    ...
    fun decimalToIpv6() {
        assertEquals(
            ...
            IpUtils.decimalToIpv6(BigInteger("50511294517568083089461819682126352108")),
        )
    }
    ...
    fun compressIpv6() {
        assertEquals(
            "::35:0:ffff:0:0",
            IpUtils.compressIpv6("0000:0000:0000:0035:0000:FFFF:0000:0000"),
        )
    }
    ...
    fun ipv4ToCidr() {
        assertArrayEquals(
            arrayOf("10.0.0.0/13", "10.8.0.0/15", "10.10.0.0/23", "10.10.2.0/24"),
            IpUtils.ipv4ToCidr("10.0.0.0", "10.10.2.255").toTypedArray(),
        )
    }
    ...
    fun cidrToIpv4() {
        assertArrayEquals(
            arrayOf("10.112.0.0", "10.127.255.255"),
