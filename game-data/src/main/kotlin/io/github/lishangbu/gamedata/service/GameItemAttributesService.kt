...
class GameItemAttributesService(
	...
	): Page<GameItemAttributesResponse> {
		validatePage(page, size)
		val search = searchFilter(query)
		return sqlClient.createQuery(GameItemAttributes::class) {
	...
	private fun entityByIdOrNotFound(id: Long): GameItemAttributes =
		repository.findNullable(id) ?: notFound("id", "道具属性不存在: $id")

	private fun GameItemAttributes.toResponse(): GameItemAttributesResponse =
