...
public class LocalizationUtils {
    ...
    /// 简体中文
    private final String SIMPLIFIED_CHINESE = "zh-Hans";

    /// 繁体中文
    private final String TRADITIONAL_CHINESE = "zh-Hant";
    ...
    /// @return 本地化的名称
    public Optional<Name> getLocalizationName(List<Name> names, String... locales) {
    ...
    /// @param locales      要查找的语言
    /// @return 本地化的描述
    public Optional<Description> getLocalizationDescription(
    ...
    /// @param locales 要查找的语言
    /// @return 本地化的效果名称
    public Optional<Effect> getLocalizationEffect(List<Effect> effects, String... locales) {
    ...
    /// @param locales        要查找的语言
    /// @return 本地化的完整效果名称
    public Optional<VerboseEffect> getLocalizationVerboseEffect(
    ...
    /// @param locales         要查找的语言
    /// @return 本地化的招式文本
    public Optional<MoveFlavorText> getLocalizationMoveFlavorText(
    ...
    /// @param locales                 要查找的语言
    /// @return 本地化的版本组偏好文本
    public Optional<VersionGroupFlavorText> getLocalizationVersionGroupFlavorText(
    ...
    /// @param locales            要查找的语言
    /// @return 本地化的特性文本
    public Optional<AbilityFlavorText> getLocalizationAbilityFlavorText(
