...
class BattleRuleCoverageServiceTests {
	...
	fun `coverage summary matches item statuses`() {
		...
		assertEquals(105, coverage.targetSummary.coveredRuleCount)
		assertEquals(207, coverage.targetSummary.remainingRuleCount)
		assertEquals(33, coverage.targetSummary.implementationPercent)
