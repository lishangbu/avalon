...
func NewAdministrationServices(
	...
	elements := element.NewService(adapters, identifiers, time.Now)
	...
	abilities := ability.NewService(adapters, identifiers, time.Now)
	itemCategories := itemcategory.NewService(adapters, identifiers, time.Now)
	itemDictionaries := itemdictionary.NewService(adapters, identifiers, time.Now)
	referenceDictionaries := referencedictionary.NewService(adapters, identifiers, time.Now)
	items := item.NewService(adapters, identifiers, time.Now)
	stats := stat.NewService(adapters, identifiers, time.Now)
