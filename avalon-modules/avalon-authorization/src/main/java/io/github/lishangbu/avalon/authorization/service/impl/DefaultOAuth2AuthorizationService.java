...
public class DefaultOAuth2AuthorizationService implements OAuth2AuthorizationService {
    ...
    public void save(OAuth2Authorization authorization) {
        ...
        authorizationOptional.ifPresent(
                oauthAuthorization -> entity.setId(oauthAuthorization.getId()));
    ...
    private OAuth2Authorization toObject(OauthAuthorization entity) {
        ...
        if (entity.getAccessTokenValue() != null) {
            ...
            builder.token(
                    accessToken, metadata -> metadata.putAll(entity.getAccessTokenMetadata()));
        }
        ...
        if (entity.getRefreshTokenValue() != null) {
            ...
            builder.token(
                    refreshToken, metadata -> metadata.putAll(entity.getRefreshTokenMetadata()));
        }
