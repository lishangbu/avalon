...
const val BATTLE_SESSIONS_API_BEARER_AUTH = OPENAPI_BEARER_SECURITY_SCHEME
...
const val BATTLE_SESSIONS_API_UNAUTHORIZED_DESCRIPTION = "未提供 Bearer access token，或 access token 无法通过校验。"
const val BATTLE_SESSIONS_API_FORBIDDEN_DESCRIPTION = "access token 有效，但缺少 battle-sessions:run 权限。"
