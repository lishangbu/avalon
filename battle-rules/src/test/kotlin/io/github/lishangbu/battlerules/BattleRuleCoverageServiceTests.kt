...
class BattleRuleCoverageServiceTests {
	...
	fun `coverage summary matches item statuses`() {
		...
		assertEquals(180, coverage.targetSummary.coveredRuleCount)
		assertEquals(132, coverage.targetSummary.remainingRuleCount)
		assertEquals(57, coverage.targetSummary.implementationPercent)
