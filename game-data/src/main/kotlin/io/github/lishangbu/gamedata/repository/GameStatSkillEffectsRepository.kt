...
class GameStatSkillEffectsRepository(
	...
	fun list(
		...
		operations.list(GAME_STAT_SKILL_EFFECTS_TABLE, page, size, query, filters)

	fun get(id: Long): GameDataRecordResponse =
		operations.get(GAME_STAT_SKILL_EFFECTS_TABLE, id)

	fun create(request: GameDataRecordRequest): GameDataRecordResponse =
		operations.create(GAME_STAT_SKILL_EFFECTS_TABLE, request)

	fun update(id: Long, request: GameDataRecordRequest): GameDataRecordResponse =
		operations.update(GAME_STAT_SKILL_EFFECTS_TABLE, id, request)

	fun delete(id: Long) {
		operations.delete(GAME_STAT_SKILL_EFFECTS_TABLE, id)
	}
}
