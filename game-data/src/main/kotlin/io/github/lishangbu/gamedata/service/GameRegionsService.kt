...
class GameRegionsService(
	...
	): Page<GameRegionsResponse> {
		validatePage(page, size)
		val search = searchFilter(query)
		return sqlClient.createQuery(GameRegions::class) {
	...
	private fun entityByIdOrNotFound(id: Long): GameRegions =
		repository.findNullable(id) ?: notFound("id", "地区资料不存在: $id")

	private fun GameRegions.toResponse(): GameRegionsResponse =
		GameRegionsResponse {
