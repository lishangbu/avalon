 ...
 * 道具口袋响应。
 */
@Schema(name = "GameItemPocketsResponse", description = "道具口袋响应。")
data class GameItemPocketsResponse(
	...
	companion object {
		fun from(record: GameDataRecordResponse): GameItemPocketsResponse =
