 ...
 * 间接伤害免疫、无视对手伤害公式能力阶级变化，以及成员出场时的能力阶级变化、天气设置和场地设置。
 *
...
sealed interface BattleAbilityEffect {
	 ...
	 * 天气防御修正、场地修正、道具倍率和特性倍率仍按各自规则继续结算。命中与闪避阶级虽然在公开规则中也属于
	 * 同类特性影响范围，但本引擎把命中流程放在状态机层，后续会用独立 fixture 接入，避免伤害公式承担命中语义。
	 */
