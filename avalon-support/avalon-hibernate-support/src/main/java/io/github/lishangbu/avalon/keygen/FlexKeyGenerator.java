...
/// 参考实现：
/// [Mybatis Flex 的
// FlexID算法](https://github.com/mybatis-flex/mybatis-flex/blob/main/mybatis-flex-core/src/main/java/com/mybatisflex/core/keygen/impl/FlexIDKeyGenerator.java)
...
public class FlexKeyGenerator {
    ...
    /// 缓存不同机器 ID 对应的生成器实例
    private static final Map<Long, FlexKeyGenerator> KEY_GENERATOR_CACHE =
