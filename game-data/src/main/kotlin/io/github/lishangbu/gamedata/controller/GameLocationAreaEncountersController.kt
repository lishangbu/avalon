...
import io.github.lishangbu.gamedata.service.GameLocationAreaEncountersService
...
class GameLocationAreaEncountersController(
	...
	): Page<GameLocationAreaEncountersResponse> = service.list(page, size, q, request.toGameDataFilters())
