...
class AddVolatileBattleMutationInterceptor : BattleMutationInterceptor {
    ...
    override fun intercept(
        ...
        val mutation = context.mutation as? AddVolatileMutation ?: return BattleMutationInterceptionResult(context.snapshot, true)
        val targetUnitIds =
        ...
        targetUnitIds.forEach { affectedTargetId ->
            val result =
                attachedEffectProcessor.process(
                    ...
                    relay = true,
                    attributes = mapOf("volatileId" to mutation.volatileId, "targetRelation" to "foe"),
                )
