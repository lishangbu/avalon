...
class ItemFlingEffectServiceImpl(
    ...
    @Transactional(rollbackFor = [Exception::class])
    override fun update(command: UpdateItemFlingEffectInput): ItemFlingEffectView = ItemFlingEffectView(itemFlingEffectRepository.save(command.toEntity(), SaveMode.UPDATE_ONLY))
