...
internal fun damagingSkill(
	...
	clearsFieldHazardsAndSubstitutes: Boolean = false,
	clearsTargetSideBarriersAndFieldHazards: Boolean = false,
	breaksProtection: Boolean = false,
	usableOnlyFirstSkillActionSinceEntering: Boolean = false,
	requiresTargetPendingDamagingSkill: Boolean = false,
	requiresTargetPendingPriorityDamagingSkill: Boolean = false,
	...
	BattleSkillSlot(
		...
		bypassesSubstitute = bypassesSubstitute,
		...
		clearsFieldHazardsAndSubstitutes = clearsFieldHazardsAndSubstitutes,
		clearsTargetSideBarriersAndFieldHazards = clearsTargetSideBarriersAndFieldHazards,
		breaksProtection = breaksProtection,
		usableOnlyFirstSkillActionSinceEntering = usableOnlyFirstSkillActionSinceEntering,
		requiresTargetPendingDamagingSkill = requiresTargetPendingDamagingSkill,
		requiresTargetPendingPriorityDamagingSkill = requiresTargetPendingPriorityDamagingSkill,
