package io.github.lishangbu.avalon.oauth2.authorizationserver.granter;
...
public class OAuth2PasswordAuthenticationProvider implements AuthenticationProvider {
  ...
  public Authentication authenticate(Authentication authentication) throws AuthenticationException {
    ...
    OAuth2PasswordAuthenticationToken resouceOwnerPasswordAuthentication =
        (OAuth2PasswordAuthenticationToken) authentication;

    OAuth2ClientAuthenticationToken clientPrincipal =
        getAuthenticatedClientElseThrowInvalidClient(resouceOwnerPasswordAuthentication);
    ...
    Authentication usernamePasswordAuthentication =
        getUsernamePasswordAuthentication(resouceOwnerPasswordAuthentication);
  ...
  private Authentication getUsernamePasswordAuthentication(
    ...
    Map<String, Object> additionalParameters =
        resouceOwnerPasswordAuthentication.getAdditionalParameters();
