...
type skillStatChangeTransactionRepository struct {
	parent   *Adapters
...
func (w *skillStatChangeTransactionRepository) Create(ctx context.Context, record skillstatchange.CreateRecord) (skillstatchange.Change, error) {
...
func (s *Adapters) GetSkillStatChange(ctx context.Context, changeID snowflake.ID) (skillstatchange.Change, error) {
...
func (s *Adapters) ListSkillStatChanges(ctx context.Context, query skillstatchange.ListQuery) (skillstatchange.Page, error) {
...
func (w *skillStatChangeTransactionRepository) Update(ctx context.Context, record skillstatchange.UpdateRecord) (skillstatchange.Change, error) {
	digest, err := idempotency.Digest(struct {
...
func (w *skillStatChangeTransactionRepository) Disable(ctx context.Context, record skillstatchange.DisableRecord) error {
	digest, err := idempotency.Digest(struct {
