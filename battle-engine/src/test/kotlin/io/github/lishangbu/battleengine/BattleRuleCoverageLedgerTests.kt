		...
		private val coverageGroups = listOf(
			...
			CoverageGroup(
				...
				testClassNames = listOf(
					...
					"io.github.lishangbu.battleengine.BattleFirstSkillActionTests",
					"io.github.lishangbu.battleengine.BattleLockedMoveTests",
					"io.github.lishangbu.battleengine.BattleMultiHitSkillTests",
					"io.github.lishangbu.battleengine.BattlePendingTargetActionSkillTests",
			...
			CoverageGroup(
				...
				testClassNames = listOf(
					...
					"io.github.lishangbu.battleengine.BattleUserHpDynamicPowerSkillTests",
				),
			),
			CoverageGroup(
			...
			CoverageGroup(
				...
				testClassNames = listOf(
					...
					"io.github.lishangbu.battleengine.BattleSkillPpReductionTests",
					...
					"io.github.lishangbu.battleengine.BattleRestAndTeamStatusCureTests",
				),
			),
			CoverageGroup(
