...
class OAuth2PasswordAuthenticationProviderTest {
    ...
    @Test
    void supportsPasswordGrantToken() {
        OAuth2PasswordAuthenticationProvider provider =
                new OAuth2PasswordAuthenticationProvider(
        ...
        assertTrue(provider.supports(OAuth2PasswordAuthorizationGrantAuthenticationToken.class));
        assertTrue(!provider.supports(UsernamePasswordAuthenticationToken.class));
    }

    private static OAuth2PasswordAuthenticationProvider provider(
