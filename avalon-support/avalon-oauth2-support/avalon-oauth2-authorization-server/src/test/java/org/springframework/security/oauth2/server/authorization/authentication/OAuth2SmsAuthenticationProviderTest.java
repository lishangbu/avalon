...
class OAuth2SmsAuthenticationProviderTest {
    ...
    void rejectsUnsupportedGrantType() {
        ...
        OAuth2SmsAuthenticationProvider provider = provider(registeredClient, null, null, null);
    ...
    void rejectsWhenAccountLockedSeconds() {
        ...
        OAuth2AuthenticationException exception =
                assertThrows(
                        ...
                        () -> provider.authenticate(smsGrantToken(registeredClient, Set.of())));
    ...
    void wrapsAuthenticationException() {
        ...
        assertEquals(OAuth2ErrorCodes.INVALID_GRANT, exception.getError().getErrorCode());
        verify(tracker).onFailure("13800000000");
    }
    ...
    void supportsSmsGrantToken() {
        ...
        assertTrue(provider.supports(OAuth2SmsAuthorizationGrantAuthenticationToken.class));
        assertTrue(!provider.supports(SmsAuthenticationToken.class));
    }

    private static OAuth2SmsAuthenticationProvider provider(
