...
class EncounterConditionValueServiceImpl(
    ...
    @Transactional(rollbackFor = [Exception::class])
    override fun update(command: UpdateEncounterConditionValueInput): EncounterConditionValueView = encounterConditionValueRepository.save(command.toEntity(), SaveMode.UPSERT).let(::reloadView)
