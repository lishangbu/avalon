...
/// 接口，定义计算契约
/// - 提供抽象基类
/// {@link io.github.lishangbu.avalon.game.calculator.growthrate.AbstractGrowthRateCalculator}
/// 包含通用边界处理与名称匹配逻辑
/// - 包含若干具体实现以支持不同的成长曲线，使用类名或内部标识进行选择与匹配
///
/// 设计与使用约定：
/// - 包内对空性的默认约定由 {@link org.jspecify.annotations.NullMarked} 注解控制，
/// 方法参数与返回值默认不可为 {@code null}
