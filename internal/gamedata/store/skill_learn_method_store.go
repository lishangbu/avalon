...
type skillLearnMethodTransactionStore struct {
	parent   *Store
...
func (w *skillLearnMethodTransactionStore) Create(ctx context.Context, record skilllearnmethod.CreateRecord) (skilllearnmethod.Method, error) {
...
func (s *Store) GetSkillLearnMethod(ctx context.Context, methodID snowflake.ID) (skilllearnmethod.Method, error) {
...
func (s *Store) ListSkillLearnMethods(ctx context.Context, query skilllearnmethod.ListQuery) (skilllearnmethod.Page, error) {
...
func (w *skillLearnMethodTransactionStore) Update(ctx context.Context, record skilllearnmethod.UpdateRecord) (skilllearnmethod.Method, error) {
	digest, err := idempotency.Digest(struct {
...
func (w *skillLearnMethodTransactionStore) Disable(ctx context.Context, record skilllearnmethod.DisableRecord) error {
	digest, err := idempotency.Digest(struct {
