...
class IpUtilsTest {
  ...
  void expandIpv6() {
    assertEquals(
        "0500:6001:00fe:0035:0000:ffff:0000:0000", IpUtils.expandIpv6("500:6001:FE:35:0:FFFF::"));
  }
  ...
  void cidrToIpv4() throws UnknownHostException {
    assertArrayEquals(
        new String[] {"10.112.0.0", "10.127.255.255"}, IpUtils.cidrToIpv4("10.123.80.0/12"));
  }
  ...
  void cidrToIpv6() throws UnknownHostException {
    assertArrayEquals(
        new String[] {
          "2002:1234:0000:0000:0000:0000:0000:0000", "2002:1234:0000:0003:ffff:ffff:ffff:ffff"
        },
