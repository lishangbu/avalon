...
class BattleRuleCoverageServiceTests {
	...
	fun `coverage summary matches item statuses`() {
		...
		assertEquals(220, coverage.targetSummary.coveredRuleCount)
		assertEquals(92, coverage.targetSummary.remainingRuleCount)
		assertEquals(70, coverage.targetSummary.implementationPercent)
