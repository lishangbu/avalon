...
type natureStoreStub struct{ value nature.Nature }

func (s *natureStoreStub) WithinNature(_ context.Context, work func(nature.Writer) error) error {
	return work(s)
}
func (s *natureStoreStub) Create(_ context.Context, record nature.CreateRecord) (nature.Nature, error) {
	s.value = record.Nature
	return s.value, nil
}
func (s *natureStoreStub) Update(_ context.Context, record nature.UpdateRecord) (nature.Nature, error) {
	s.value = record.Nature
	return s.value, nil
}
func (s *natureStoreStub) Get(context.Context, snowflake.ID) (nature.Nature, error) {
	return s.value, nil
}
func (s *natureStoreStub) List(context.Context, nature.ListQuery) (nature.Page, error) {
