...
class GameGendersService(
	...
	): Page<GameGendersResponse> {
		validatePage(page, size)
		val search = searchFilter(query)
		return sqlClient.createQuery(GameGenders::class) {
	...
	private fun entityByIdOrNotFound(id: Long): GameGenders =
		repository.findNullable(id) ?: notFound("id", "性别资料不存在: $id")

	private fun GameGenders.toResponse(): GameGendersResponse =
		GameGendersResponse {
