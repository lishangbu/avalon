...
// battleRuleTransactionStore 闅旂鎴樻枟瑙勫垯 Writer 鐨勪簨鍔℃柟娉曢泦鍚堛€?
type battleRuleTransactionStore struct {
	parent   *Store
...
func (w *battleRuleTransactionStore) CreateFormat(ctx context.Context, record battleformat.CreateFormatRecord) (battleformat.Format, error) {
...
func (w *battleRuleTransactionStore) UpdateFormat(ctx context.Context, record battleformat.UpdateFormatRecord) (battleformat.Format, error) {
	digest, err := idempotency.Digest(struct {
...
func (w *battleRuleTransactionStore) DisableFormat(ctx context.Context, record battleformat.DisableFormatRecord) error {
	digest, err := idempotency.Digest(struct {
		ExpectedVersion int64
...
func (s *Store) GetFormat(ctx context.Context, id snowflake.ID) (battleformat.Format, error) {
...
func (s *Store) ListFormats(ctx context.Context, query battleformat.FormatListQuery) (battleformat.FormatPage, error) {
