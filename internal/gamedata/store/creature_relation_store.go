...
func (s *Store) GetCreatureRelations(ctx context.Context, creatureID snowflake.ID) (creaturemetadata.CreatureRelations, error) {
...
func (w *creatureDataTransactionStore) ReplaceCreatureRelations(ctx context.Context, record creaturemetadata.ReplaceRelationsRecord) (creaturemetadata.CreatureRelations, error) {
...
func (w *creatureDataTransactionStore) saveCreatureRelations(ctx context.Context, record creaturemetadata.ReplaceRelationsRecord) error {
...
func (w *creatureDataTransactionStore) disableMissingCreatureRelations(ctx context.Context, creatureID snowflake.ID, relations creaturemetadata.CreatureRelations, at pgtype.Timestamptz) error {
	creatureEntID := creatureID
