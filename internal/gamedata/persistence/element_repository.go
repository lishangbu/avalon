...
func (w *transactionRepository) Create(ctx context.Context, record element.CreateRecord) (element.Element, error) {
...
func (s *Adapters) Get(ctx context.Context, elementID snowflake.ID) (element.Element, error) {
...
func (s *Adapters) List(ctx context.Context, query element.ListQuery) (element.Page, error) {
...
func (w *transactionRepository) Update(ctx context.Context, record element.UpdateRecord) (element.Element, error) {
	digest, err := idempotency.Digest(struct {
...
func (w *transactionRepository) Disable(ctx context.Context, record element.DisableRecord) error {
	digest, err := idempotency.Digest(struct {
		ElementID       snowflake.ID
		ExpectedVersion int64
