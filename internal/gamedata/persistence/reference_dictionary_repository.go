...
func (s *Adapters) ListReferenceDictionary(ctx context.Context, kind referencedictionary.Kind) ([]referencedictionary.Entry, error) {
...
func (s *Adapters) CreateReferenceDictionary(ctx context.Context, entry referencedictionary.Entry, write administration.GameDataWriteContext, at time.Time) (referencedictionary.Entry, error) {
	return s.writeReferenceDictionary(ctx, entry, 0, write, at, true)
}

// UpdateReferenceDictionary 在单一事务中按乐观版本更新资料。
func (s *Adapters) UpdateReferenceDictionary(ctx context.Context, entry referencedictionary.Entry, expectedVersion int64, write administration.GameDataWriteContext, at time.Time) (referencedictionary.Entry, error) {
	return s.writeReferenceDictionary(ctx, entry, expectedVersion, write, at, false)
}

func (s *Adapters) writeReferenceDictionary(ctx context.Context, entry referencedictionary.Entry, expectedVersion int64, write administration.GameDataWriteContext, at time.Time, create bool) (referencedictionary.Entry, error) {
