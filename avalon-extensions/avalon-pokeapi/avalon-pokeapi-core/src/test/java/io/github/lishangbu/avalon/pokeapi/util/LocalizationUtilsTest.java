...
class LocalizationUtilsTest {
    ...
    void testGetLocalizationDescriptionWithMatchingLocale() {
        ...
        Optional<Description> result =
                LocalizationUtils.getLocalizationDescription(descriptions, "en");
    ...
    void testGetLocalizationDescriptionWithNoMatchingLocale() {
        ...
        Optional<Description> result =
                LocalizationUtils.getLocalizationDescription(descriptions, "fr");
    ...
    void testGetLocalizationVerboseEffectWithDefaultLocales() {
        ...
        Optional<VerboseEffect> result =
                LocalizationUtils.getLocalizationVerboseEffect(verboseEffects);
    ...
    void testGetLocalizationVerboseEffectWithMultipleMatchingLocales() {
        ...
        Optional<VerboseEffect> result =
                LocalizationUtils.getLocalizationVerboseEffect(
                        verboseEffects, "fr", "zh-Hant", "en");
    ...
    void testGetLocalizationVersionGroupFlavorTextWithEmptyList() {
        ...
        Optional<VersionGroupFlavorText> result =
                LocalizationUtils.getLocalizationVersionGroupFlavorText(
                        emptyVersionGroupFlavorTexts, "en");
    ...
    void testGetLocalizationMoveFlavorTextWithMultipleMatchingLocales() {
        ...
        Optional<MoveFlavorText> result =
                LocalizationUtils.getLocalizationMoveFlavorText(
                        moveFlavorTexts, "fr", "zh-Hant", "en");
    ...
    void testGetLocalizationMoveFlavorTextWithNullMoveFlavorTexts() {
        ...
        Optional<MoveFlavorText> result =
                LocalizationUtils.getLocalizationMoveFlavorText(null, "en");
