...
type skillTargetTransactionStore struct {
	parent   *Store
...
func (w *skillTargetTransactionStore) Create(ctx context.Context, record skilltarget.CreateRecord) (skilltarget.Target, error) {
...
func (s *Store) GetSkillTarget(ctx context.Context, targetID snowflake.ID) (skilltarget.Target, error) {
...
func (s *Store) ListSkillTargets(ctx context.Context, query skilltarget.ListQuery) (skilltarget.Page, error) {
...
func (w *skillTargetTransactionStore) Update(ctx context.Context, record skilltarget.UpdateRecord) (skilltarget.Target, error) {
	digest, err := idempotency.Digest(struct {
...
func (w *skillTargetTransactionStore) Disable(ctx context.Context, record skilltarget.DisableRecord) error {
	digest, err := idempotency.Digest(struct {
