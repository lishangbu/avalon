...
class GameEvolutionTriggersService(
	...
	): Page<GameEvolutionTriggersResponse> {
		validatePage(page, size)
		val search = searchFilter(query)
		return sqlClient.createQuery(GameEvolutionTriggers::class) {
	...
	private fun entityByIdOrNotFound(id: Long): GameEvolutionTriggers =
		repository.findNullable(id) ?: notFound("id", "进化触发器不存在: $id")

	private fun GameEvolutionTriggers.toResponse(): GameEvolutionTriggersResponse =
