...
import io.github.lishangbu.gamedata.service.GameSpeciesCreatureVarietiesService
...
class GameSpeciesCreatureVarietiesController(
	...
	): Page<GameSpeciesCreatureVarietiesResponse> = service.list(page, size, q, request.toGameDataFilters())
