...
class GameSkillDamageClassService(
	...
	): Page<GameSkillDamageClassResponse> {
		validatePage(page, size)
		val search = searchFilter(query)
		return sqlClient.createQuery(GameSkillDamageClass::class) {
	...
	private fun entityByIdOrNotFound(id: Long): GameSkillDamageClass =
		repository.findNullable(id) ?: notFound("id", "技能分类不存在: $id")

	private fun GameSkillDamageClass.toResponse(): GameSkillDamageClassResponse =
