...
import io.github.lishangbu.gamedata.service.GameLocationAreaMethodRatesService
...
class GameLocationAreaMethodRatesController(
	private val service: GameLocationAreaMethodRatesService,
) {
	@Operation(summary = "分页查询区域遭遇方式概率")
	@ApiResponses(
		value = [
	...
	): GameDataPageResponse<GameLocationAreaMethodRatesResponse> = service.list(page, size, q, request.toGameDataFilters())

	@Operation(summary = "读取单条区域遭遇方式概率")
	@ApiResponses(
		value = [
			ApiResponse(responseCode = "200", description = "读取成功", content = [Content(mediaType = "application/json", schema = Schema(implementation = GameLocationAreaMethodRatesResponse::class))]),
			ApiResponse(responseCode = "401", description = GAME_DATA_API_UNAUTHORIZED_DESCRIPTION, content = [Content(mediaType = "application/json", schema = Schema(implementation = ApiErrorResponse::class))]),
			ApiResponse(responseCode = "403", description = GAME_DATA_API_FORBIDDEN_DESCRIPTION, content = [Content(mediaType = "application/json", schema = Schema(implementation = ApiErrorResponse::class))]),
	...
	@GetMapping("/{id}")
	fun get(@PathVariable id: Long): GameLocationAreaMethodRatesResponse = service.get(id)

	@Operation(summary = "新增区域遭遇方式概率")
	@ApiResponses(
		value = [
			ApiResponse(responseCode = "200", description = "新增成功", content = [Content(mediaType = "application/json", schema = Schema(implementation = GameLocationAreaMethodRatesResponse::class))]),
			ApiResponse(responseCode = "400", description = GAME_DATA_API_BAD_REQUEST_DESCRIPTION, content = [Content(mediaType = "application/json", schema = Schema(implementation = ApiErrorResponse::class))]),
			ApiResponse(responseCode = "401", description = GAME_DATA_API_UNAUTHORIZED_DESCRIPTION, content = [Content(mediaType = "application/json", schema = Schema(implementation = ApiErrorResponse::class))]),
			ApiResponse(responseCode = "403", description = GAME_DATA_API_FORBIDDEN_DESCRIPTION, content = [Content(mediaType = "application/json", schema = Schema(implementation = ApiErrorResponse::class))]),
	...
	@PostMapping
	fun create(@RequestBody request: GameLocationAreaMethodRatesRequest): GameLocationAreaMethodRatesResponse = service.create(request)

	@Operation(summary = "修改区域遭遇方式概率")
	@ApiResponses(
		value = [
			ApiResponse(responseCode = "200", description = "修改成功", content = [Content(mediaType = "application/json", schema = Schema(implementation = GameLocationAreaMethodRatesResponse::class))]),
			ApiResponse(responseCode = "400", description = GAME_DATA_API_BAD_REQUEST_DESCRIPTION, content = [Content(mediaType = "application/json", schema = Schema(implementation = ApiErrorResponse::class))]),
			ApiResponse(responseCode = "401", description = GAME_DATA_API_UNAUTHORIZED_DESCRIPTION, content = [Content(mediaType = "application/json", schema = Schema(implementation = ApiErrorResponse::class))]),
			ApiResponse(responseCode = "403", description = GAME_DATA_API_FORBIDDEN_DESCRIPTION, content = [Content(mediaType = "application/json", schema = Schema(implementation = ApiErrorResponse::class))]),
			ApiResponse(responseCode = "404", description = GAME_DATA_API_NOT_FOUND_DESCRIPTION, content = [Content(mediaType = "application/json", schema = Schema(implementation = ApiErrorResponse::class))]),
	...
	@PutMapping("/{id}")
	fun update(@PathVariable id: Long, @RequestBody request: GameLocationAreaMethodRatesRequest): GameLocationAreaMethodRatesResponse = service.update(id, request)

	@Operation(summary = "删除区域遭遇方式概率")
	@ApiResponses(
		value = [
