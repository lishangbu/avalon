...
func (w *battleRuleTransactionRepository) CreateMechanic(ctx context.Context, record battleformat.CreateMechanicRecord) (battleformat.Mechanic, error) {
...
func (w *battleRuleTransactionRepository) UpdateMechanic(ctx context.Context, record battleformat.UpdateMechanicRecord) (battleformat.Mechanic, error) {
...
func (w *battleRuleTransactionRepository) DisableMechanic(ctx context.Context, record battleformat.DisableMechanicRecord) error {
...
func (s *Adapters) GetMechanic(ctx context.Context, id snowflake.ID) (battleformat.Mechanic, error) {
...
func (s *Adapters) ListMechanics(ctx context.Context, query battleformat.MechanicListQuery) (battleformat.MechanicPage, error) {
