...
// itemCategoryTransactionStore 闅旂閬撳叿鍒嗙被 Writer 鐨勬柟娉曢泦鍚堛€?
type itemCategoryTransactionStore struct {
	parent   *Store
...
func (w *itemCategoryTransactionStore) Create(
	ctx context.Context,
...
func (s *Store) GetItemCategory(ctx context.Context, categoryID snowflake.ID) (itemcategory.Category, error) {
...
func (s *Store) ListItemCategories(ctx context.Context, query itemcategory.ListQuery) (itemcategory.Page, error) {
...
func (w *itemCategoryTransactionStore) Update(
	ctx context.Context,
...
func (w *itemCategoryTransactionStore) Disable(ctx context.Context, record itemcategory.DisableRecord) error {
	digest, err := idempotency.Digest(struct {
		CategoryID      snowflake.ID
		ExpectedVersion int64
