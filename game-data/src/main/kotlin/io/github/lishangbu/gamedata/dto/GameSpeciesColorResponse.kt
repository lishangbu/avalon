 ...
 * 种类颜色响应。
 */
@Schema(name = "GameSpeciesColorResponse", description = "种类颜色响应。")
data class GameSpeciesColorResponse(
	...
	companion object {
		fun from(record: GameDataRecordResponse): GameSpeciesColorResponse =
