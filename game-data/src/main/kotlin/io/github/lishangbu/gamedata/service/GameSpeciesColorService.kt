...
class GameSpeciesColorService(
	...
	): Page<GameSpeciesColorResponse> {
		validatePage(page, size)
		val search = searchFilter(query)
		return sqlClient.createQuery(GameSpeciesColor::class) {
	...
	private fun entityByIdOrNotFound(id: Long): GameSpeciesColor =
		repository.findNullable(id) ?: notFound("id", "种类颜色不存在: $id")

	private fun GameSpeciesColor.toResponse(): GameSpeciesColorResponse =
