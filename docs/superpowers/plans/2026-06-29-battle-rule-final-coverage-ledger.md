...
| `hit-protect-substitute-immunity-reflect` | 81-108 | 28 | `BattleEndurePublicReferenceTests`、`BattleHitDefenseBoundaryPublicReferenceTests`、`BattleProtectionBreakingSkillTests`、`BattleSubstituteTests`、`BattleSideGuardSkillTests`、`BattleImmunityTests`、`BattleAccuracyStatStageIgnoreAbilityTests`、`BattlePsychicTerrainTests`、`BattleSoundAbilityTests`、`BattleStatusImmunityAndGroundingTests` |
