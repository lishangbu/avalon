...
class BattleRuleCoverageServiceTests {
	...
	fun `coverage summary matches item statuses`() {
		...
		assertEquals(81, coverage.targetSummary.coveredRuleCount)
		assertEquals(231, coverage.targetSummary.remainingRuleCount)
		assertEquals(25, coverage.targetSummary.implementationPercent)
