...
class GameEventStatsService(
	...
	): Page<GameEventStatsResponse> {
		validatePage(page, size)
		val search = searchFilter(query)
		return sqlClient.createQuery(GameEventStats::class) {
	...
	private fun entityByIdOrNotFound(id: Long): GameEventStats =
		repository.findNullable(id) ?: notFound("id", "活动能力项不存在: $id")

	private fun GameEventStats.toResponse(): GameEventStatsResponse =
