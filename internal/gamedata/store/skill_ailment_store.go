...
// skillAilmentTransactionStore 闅旂鎶€鑳藉紓甯?Writer 鐨勬柟娉曢泦鍚堛€?
type skillAilmentTransactionStore struct {
	parent   *Store
...
func (w *skillAilmentTransactionStore) Create(
	ctx context.Context,
...
func (s *Store) GetSkillAilment(ctx context.Context, ailmentID snowflake.ID) (skillailment.Ailment, error) {
...
func (s *Store) ListSkillAilments(ctx context.Context, query skillailment.ListQuery) (skillailment.Page, error) {
...
func (w *skillAilmentTransactionStore) Update(
	ctx context.Context,
...
func (w *skillAilmentTransactionStore) Disable(ctx context.Context, record skillailment.DisableRecord) error {
	digest, err := idempotency.Digest(struct {
