...
type skillCategoryTransactionRepository struct {
	parent   *Adapters
...
func (w *skillCategoryTransactionRepository) Create(ctx context.Context, record skillcategory.CreateRecord) (skillcategory.Category, error) {
...
func (s *Adapters) GetSkillCategory(ctx context.Context, categoryID snowflake.ID) (skillcategory.Category, error) {
...
func (s *Adapters) ListSkillCategories(ctx context.Context, query skillcategory.ListQuery) (skillcategory.Page, error) {
...
func (w *skillCategoryTransactionRepository) Update(ctx context.Context, record skillcategory.UpdateRecord) (skillcategory.Category, error) {
	digest, err := idempotency.Digest(struct {
...
func (w *skillCategoryTransactionRepository) Disable(ctx context.Context, record skillcategory.DisableRecord) error {
	digest, err := idempotency.Digest(struct {
