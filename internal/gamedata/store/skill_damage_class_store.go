...
// skillDamageClassTransactionStore 闅旂鎶€鑳戒激瀹冲垎绫?Writer 鐨勬柟娉曢泦鍚堛€?
type skillDamageClassTransactionStore struct {
	parent   *Store
...
func (w *skillDamageClassTransactionStore) Create(
	ctx context.Context,
...
func (s *Store) GetSkillDamageClass(
	ctx context.Context,
...
func (s *Store) ListSkillDamageClasses(
	ctx context.Context,
...
func (w *skillDamageClassTransactionStore) Update(
	ctx context.Context,
...
func (w *skillDamageClassTransactionStore) Disable(
	ctx context.Context,
