 ...
 * 技能元分类响应。
 */
@Schema(name = "GameSkillCategoriesResponse", description = "技能元分类响应。")
data class GameSkillCategoriesResponse(
	...
	companion object {
		fun from(record: GameDataRecordResponse): GameSkillCategoriesResponse =
