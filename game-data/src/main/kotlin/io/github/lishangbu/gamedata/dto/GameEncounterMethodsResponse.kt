 ...
 * 遭遇方式响应。
 */
@Schema(name = "GameEncounterMethodsResponse", description = "遭遇方式响应。")
data class GameEncounterMethodsResponse(
	...
	companion object {
		fun from(record: GameDataRecordResponse): GameEncounterMethodsResponse =
