...
class GameBerryFirmnessesService(
	...
	): Page<GameBerryFirmnessesResponse> {
		validatePage(page, size)
		val search = searchFilter(query)
		return sqlClient.createQuery(GameBerryFirmnesses::class) {
	...
	private fun entityByIdOrNotFound(id: Long): GameBerryFirmnesses =
		repository.findNullable(id) ?: notFound("id", "树果硬度不存在: $id")

	private fun GameBerryFirmnesses.toResponse(): GameBerryFirmnessesResponse =
