...
type creatureDataTransactionRepository struct {
	parent   *Adapters
...
func (s *Adapters) GetReferenceOptions(ctx context.Context) (creaturemetadata.ReferenceOptions, error) {
...
func (s *Adapters) WithinCreatureData(ctx context.Context, work func(creaturemetadata.ManagementWriter) error) error {
	return s.pool.WithinTransaction(ctx, func(transactionCtx context.Context) error {
		...
		return work(&creatureDataTransactionRepository{parent: s, client: s.pool.Client(transactionCtx), executor: executor})
	})
}

// ListSpecies 返回管理端所需的 Species 有界资料页。
func (s *Adapters) ListSpecies(ctx context.Context, query creaturemetadata.SpeciesListQuery) (creaturemetadata.SpeciesPage, error) {
...
func (s *Adapters) GetSpecies(ctx context.Context, id snowflake.ID) (creaturemetadata.ManagedSpecies, error) {
...
func (s *Adapters) ListCreatures(ctx context.Context, query creaturemetadata.CreatureListQuery) (creaturemetadata.CreaturePage, error) {
...
func (s *Adapters) GetCreature(ctx context.Context, id snowflake.ID) (creaturemetadata.ManagedCreature, error) {
...
func (w *creatureDataTransactionRepository) CreateSpecies(ctx context.Context, record creaturemetadata.CreateSpeciesRecord) (creaturemetadata.ManagedSpecies, error) {
...
func (w *creatureDataTransactionRepository) UpdateSpecies(ctx context.Context, record creaturemetadata.UpdateSpeciesRecord) (creaturemetadata.ManagedSpecies, error) {
	value := record.Species
...
func (w *creatureDataTransactionRepository) CreateCreature(ctx context.Context, record creaturemetadata.CreateCreatureRecord) (creaturemetadata.ManagedCreature, error) {
...
func (w *creatureDataTransactionRepository) UpdateCreature(ctx context.Context, record creaturemetadata.UpdateCreatureRecord) (creaturemetadata.ManagedCreature, error) {
	value := record.Creature
...
func (w *creatureDataTransactionRepository) replaceSpeciesEggGroups(ctx context.Context, speciesID snowflake.ID, eggGroupIDs []snowflake.ID) error {
...
func (w *creatureDataTransactionRepository) completeCreatureWrite[T any](ctx context.Context, writeContext administration.GameDataWriteContext, at time.Time, action, resource string, id snowflake.ID, before, after any, request idempotency.Request, writer *idempotency.PersistentWriter, response T) error {
