...
class BattleRuntimePolicyMapperTests {
	...
	fun `switch in ally and field policies map effects`() {
		...
		assertThat("terastallization-stat-attack-plus-one".toBattleAbilityEffect(elementIds))
			.isEqualTo(BattleAbilityEffect.TerastallizationStatStageChange(BattleStat.ATTACK, 1))
		assertThat("terastallization-stat-defense-plus-one".toBattleAbilityEffect(elementIds))
			.isEqualTo(BattleAbilityEffect.TerastallizationStatStageChange(BattleStat.DEFENSE, 1))
		assertThat("terastallization-stat-special-defense-plus-one".toBattleAbilityEffect(elementIds))
			.isEqualTo(BattleAbilityEffect.TerastallizationStatStageChange(BattleStat.SPECIAL_DEFENSE, 1))
		assertThat("terastallization-stat-speed-plus-one".toBattleAbilityEffect(elementIds))
			.isEqualTo(BattleAbilityEffect.TerastallizationStatStageChange(BattleStat.SPEED, 1))
