...
interface CatalogRepository {
     ...
     * 创建属性定义。
     *
     * @param draft 属性定义草稿，包含业务 code、展示名和排序信息。
     * @return 已持久化的属性定义。
     */
     ...
     * 创建属性克制关系。
     *
     * @param draft 克制关系草稿，包含攻击方、防御方与倍率。
     * @return 已持久化的克制关系。
     */
