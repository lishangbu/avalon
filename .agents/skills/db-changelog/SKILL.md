...
在处理 Liquibase YAML 变更前，先确定仓库里是否存在 `references/db-changelog-conventions.md`。
...
- 如果当前仓库沿用本项目的数据库目录结构，优先对照 `db/changelog/versions/0.0.1/0.0.1.yaml`
...
- 优先读取目标仓库中的`references/db-changelog-conventions.md`
