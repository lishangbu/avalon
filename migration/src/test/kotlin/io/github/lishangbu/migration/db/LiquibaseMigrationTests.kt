...
class LiquibaseMigrationTests(
	...
	fun `liquibase changelog history keeps single initial file and numbered follow ups`() {
		...
		assertThat(changelogFiles).containsExactly(
			...
			"032-battle-rule-protection-priority-fixtures.yaml",
			"033-battle-rule-existing-status-fixtures.yaml",
			"034-battle-rule-existing-confusion-fixtures.yaml",
			"035-battle-rule-weather-fixtures.yaml",
			"036-battle-rule-status-fixtures.yaml",
			"037-battle-rule-damage-formula-fixtures.yaml",
			...
			"099-battle-action-flow-boundary-fixtures.yaml",
			"100-battle-validation-fixtures.yaml",
			"101-battle-replay-fixtures.yaml",
			"102-battle-target-scope-fixtures.yaml",
			"103-battle-action-ordering-fixtures.yaml",
			"104-battle-lifecycle-switch-fixtures.yaml",
			"105-battle-target-redirection-fixtures.yaml",
			"106-battle-random-target-fixtures.yaml",
			"107-battle-hit-defense-boundary-fixtures.yaml",
	...
	fun `liquibase creates battle rules tables with seed rows`() {
		...
		assertThat(seedCounts).containsEntry("battle_rule_fixture", 399L)
		assertThat(seedCounts).containsEntry("battle_rule_fixture_source", 799L)
		assertThat(seedCounts).containsEntry("battle_rule_test_run", 399L)
