...
/// @param affectingMoves   影响此属性的技能集合 [MoveStatAffectSets]
/// @param affectingNatures 影响此属性的性格集合 [NatureStatAffectSets]
/// @param characteristics  当宝可梦最高基础属性为此属性时的特征列表 [Characteristic]
/// @param moveDamageClass  与此属性相关的伤害类别 [MoveDamageClass]
