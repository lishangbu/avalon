...
import io.github.lishangbu.gamedata.service.GameCreatureAbilityService
...
class GameCreatureAbilityController(
	...
	): Page<GameCreatureAbilityResponse> = service.list(page, size, q, request.toGameDataFilters())
