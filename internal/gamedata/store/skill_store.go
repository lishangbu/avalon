...
// skillTransactionStore 闅旂鎶€鑳戒富浣撹祫鏂?Writer 鐨勬柟娉曢泦鍚堛€?
type skillTransactionStore struct {
	parent   *Store
...
func (w *skillTransactionStore) Create(ctx context.Context, record skill.CreateRecord) (skill.Skill, error) {
...
func (s *Store) GetSkill(ctx context.Context, skillID snowflake.ID) (skill.Skill, error) {
...
func (s *Store) ListSkills(ctx context.Context, query skill.ListQuery) (skill.Page, error) {
...
func (w *skillTransactionStore) Update(ctx context.Context, record skill.UpdateRecord) (skill.Skill, error) {
	digest, err := idempotency.Digest(struct {
		Skill           skill.Skill
...
func (w *skillTransactionStore) Disable(ctx context.Context, record skill.DisableRecord) error {
	digest, err := idempotency.Digest(struct {
