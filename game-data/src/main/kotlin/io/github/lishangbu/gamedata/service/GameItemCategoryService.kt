...
class GameItemCategoryService(
	...
	): Page<GameItemCategoryResponse> {
		validatePage(page, size)
		val search = searchFilter(query)
		return sqlClient.createQuery(GameItemCategory::class) {
	...
	private fun entityByIdOrNotFound(id: Long): GameItemCategory =
		repository.findNullable(id) ?: notFound("id", "道具分类不存在: $id")

	private fun GameItemCategory.toResponse(): GameItemCategoryResponse =
