...
func (s *QueryService) GetActive(
	...
	return s.query.GetActive(ctx, accountID, playerCharacterID)
}
...
func NewQueryService(query Query) *QueryService {
...
func (s *QueryService) GetOwned(
	...
	return s.query.GetOwned(ctx, accountID, playerCharacterID, teamID)
}
