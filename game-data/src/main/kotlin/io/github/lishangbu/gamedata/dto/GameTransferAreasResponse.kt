 ...
 * 迁移区域响应。
 */
@Schema(name = "GameTransferAreasResponse", description = "迁移区域响应。")
data class GameTransferAreasResponse(
	...
	companion object {
		fun from(record: GameDataRecordResponse): GameTransferAreasResponse =
