...
class CreatureVariantInputJacksonTest {
    ...
    @Test
    fun updateCreatureVariantInput_canBeDeserializedFromFlatPayload() {
        val payload =
            """
            {
              "id": "1",
        ...
        val input = objectMapper.readValue(payload, UpdateCreatureVariantInput::class.java)
        ...
        assertEquals("1", input.creatureId)
    }
}
