BEGIN;
insert into public.berry (id, bulk, growth_time, internal_name, max_harvest, name, natural_gift_power, smoothness,
                          soil_dryness, berry_firmness_id, natural_gift_type_id)
