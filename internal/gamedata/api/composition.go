...
func NewAdministrationServices(
	...
	skillCategories := skillcategory.NewService(adapters, adapters, adapters, identifiers, time.Now)
	skillTargets := skilltarget.NewService(adapters, adapters, adapters, identifiers, time.Now)
	skillLearnMethods := skilllearnmethod.NewService(adapters, adapters, adapters, identifiers, time.Now)
