...
func (w *battleRuleTransactionStore) CreateClause(ctx context.Context, record battleformat.CreateClauseRecord) (battleformat.Clause, error) {
...
func (w *battleRuleTransactionStore) UpdateClause(ctx context.Context, record battleformat.UpdateClauseRecord) (battleformat.Clause, error) {
...
func (w *battleRuleTransactionStore) DisableClause(ctx context.Context, record battleformat.DisableClauseRecord) error {
...
func (s *Store) GetClause(ctx context.Context, id snowflake.ID) (battleformat.Clause, error) {
...
func (s *Store) ListClauses(ctx context.Context, query battleformat.ClauseListQuery) (battleformat.ClausePage, error) {
