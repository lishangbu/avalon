...
class BattleRuleCoverageServiceTests {
	...
	fun `coverage summary matches item statuses`() {
		...
		assertEquals(120, coverage.targetSummary.coveredRuleCount)
		assertEquals(192, coverage.targetSummary.remainingRuleCount)
		assertEquals(38, coverage.targetSummary.implementationPercent)
